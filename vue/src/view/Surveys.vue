<template>
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-col-2 md:grid-cols-3">
      ...
      >
        <img :src="survey.img" alt="" class="w-full h-48 object-cover" />
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          <button
            ...
            class="h-6 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-offset-2 focus:ring-red-500"
          >
            <svg
              class="w-6 h-6"
              fill="none"
